  ...
  return (
    <motion.nav
      ...
      style={{
        ...
        background: "rgba(8,12,20,0.5)", backdropFilter: "blur(40px)",
        WebkitBackdropFilter: "blur(40px)",
        borderBottom: "1px solid rgba(0,200,255,0.04)",
        height: isMobile ? "50px" : "56px",
        display: "flex", alignItems: "center", justifyContent: "space-between",
        padding: isMobile ? "0 12px" : "0 24px 0 30px", direction: "rtl",
      }}
    >
      <div style={{ display: "flex", alignItems: "center", gap: isMobile ? "6px" : "12px" }}>
        <motion.button
          ...
          style={{
            background: "rgba(0,200,255,0.06)", border: "1px solid rgba(0,200,255,0.1)",
            borderRadius: "10px", width: isMobile ? "32px" : "36px",
            height: isMobile ? "32px" : "36px", display: "flex",
        ...
        <motion.div
          style={{
            ...
            fontSize: isMobile ? "0.65rem" : "0.85rem", fontWeight: 700,
            color: "#00e5ff", direction: "ltr", whiteSpace: "nowrap",
      ...
      <div style={{ textAlign: "center", display: isMobile ? "none" : "block" }}>
        <div style={{ fontSize: "0.8rem", fontWeight: 700, color: "#fff", letterSpacing: "0.5px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: isMobile ? "6px" : "14px" }}>
        ...
        >
          <div style={{ textAlign: "left", direction: "ltr", display: isMobile ? "none" : "block" }}>
            <div style={{ fontSize: "0.65rem", fontWeight: 700, color: "#e6edf3" }}>
              {user?.name || "مستخدم"}
            </div>
          ...
          <div style={{
            ...
            borderRadius: "50%", background: "linear-gradient(135deg, #00e5ff, #a855f7)",
